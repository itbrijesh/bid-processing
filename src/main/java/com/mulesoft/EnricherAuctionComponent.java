...
public class EnricherAuctionComponent {
    ...
    private String enrichSingle(String bid) throws InterruptedException{
    	System.out.println("EnricherAuctionComponent >> enrichSingle: " + bid );
        ...
        System.out.println("EnricherAuctionComponent >> enrichSingle: (Result) " + bid );
        
        return bid;
        
    }
    public Object enrichBids(String bids) throws InterruptedException {
        System.out.println("EnricherAuctionComponent >> enrichBids: " + bids );
